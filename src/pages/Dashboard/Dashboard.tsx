...
import ExpensesDataGrid from "../Expenses/ExpensesDataGrid/ExpensesDataGrid.tsx";
...
const rows = [
    createExpenseRow(1, Date.now(), 'Amazon', categories[0], 4.0),
    createExpenseRow(2, Date.now(), 'Amazon', categories[2], 4.0),
    createExpenseRow(3, Date.now(), 'Amazon', categories[1], 4.0),
    createExpenseRow(4, Date.now(), 'Amazon', categories[2], 4.0),
    createExpenseRow(4, Date.now(), 'Amazon', categories[2], 4.0),
]
    ...
    return <>
        <Grid container>
            ...
            <Grid item lg={9} md={12} xs={12} my={2}>
                <ExpensesDataGrid rows={rows} dense={true} onClick={() => console.log("row clicked")}/>
            </Grid>
        </Grid>
